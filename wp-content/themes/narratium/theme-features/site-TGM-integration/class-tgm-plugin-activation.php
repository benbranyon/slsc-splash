 ...
 * @version   2.6.1 for parent theme Narratium for publication on ThemeForest
	...
	class TGM_Plugin_Activation {
		...
		public function load_textdomain() {
			...
			if ( false !== strpos( __FILE__, WP_PLUGIN_DIR ) || false !== strpos( __FILE__, WPMU_PLUGIN_DIR ) ) {
				...
				load_theme_textdomain( 'tgmpa', get_parent_theme_file_path('theme-features/site-TGM-integration/languages') );
		...
		public function filter_plugin_action_links_update( $actions ) {
			$actions['update'] = sprintf(
				...
				esc_attresc_html__( 'This plugin needs to be updated to be compatible with your theme.', 'tgmpa' ),
