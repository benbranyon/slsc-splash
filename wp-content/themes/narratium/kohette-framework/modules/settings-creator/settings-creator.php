...
/**
* We also call the classes regarding the customize options
*/
...
class KTT_new_section {
    ...
    */
    function __construct($args) {
        ...
        $this->section_description = (isset($args['section_description']) ? $args['section_description'] : '');
    ...
    function section_description() {
        ?>
        <p><?php echo esc_html($this->section_description);?></p>
        <?php
    }
...
class KTT_new_setting {
        ...
        */
        ...
        function fields_html() {
            ...
            /**
            * If the option has a callback it means that an external function will generate the fields / form of the option, therefore we do not call the hook that is responsible for generating the default option fields of the framework
            */
...
// load options
foreach (glob(get_parent_theme_file_path("kohette-framework/modules/settings-creator/options/*"), GLOB_ONLYDIR) as $filename) {
